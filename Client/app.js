...
// postData('/addData', projectData, {place: zipcode, weather: projectData.newData.clouds.all, temp: projectData.newData.main.temp.toFixed()} )
// return projectData
// }).then(function(projectData){updateUi(
// {place: zipcode, weather: projectData.clouds.all, temp: projectData.main.temp.toFixed()})})
}
